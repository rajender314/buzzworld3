...
export default function PricingRuleConfigurator() {
  ...
  // const getSuppliersList = (indx?: any) => {
  //  console.log(formik.current.values.pricing_rules.length, indx);
  //  const params = {
  //    status: true,
  //    is_add_row: formik.current.values.pricing_rules.length > 1 ? true : false,
  ...
  const filterSupplierData = async (inputValue: string, indx?: any) => {
    let options: any = [];
    if (inputValue.length >= 3) {
      const params = {
        status: true,
  ...
  const promiseOptions = (
    ...
    new Promise((resolve) => {
      ...
      current.timer = setTimeout(() => {
        ...
        } else if (flag === "supplierlist") {
          resolve(filterSupplierData(inputValue, index));
        } else {
  ...
  //  if (value) {
  //    let obj: any = { value: value.value, label: value.label };
  //    customerName = obj.value;
  //    setCustomerName(obj);
  //  } else {
  //    customerName = "";
  //    setCustomerName("");
  ...
  const resetValuesonSupplierChange = (
    ...
    replace(indx, newValues);
    initialValues.pricing_rules[indx].supplier = e;
    initialValues.pricing_rules[indx].item_range_specification = "";
    setInitialvalues(initialValues);
  };
  ...
  const onSupplierChange = (
    ...
    if (e) {
      ...
      getDiscountCodes();
      const obj: any = { value: e.value, label: e.name };
      formik.current.setFieldValue(`pricing_rules.${indx}.supplier`, obj);
      // getSpecialPrice()
    } else {
      resetValuesonSupplierChange("", indx, replace);
      formik.current.setFieldValue(`pricing_rules.${indx}.supplier`, e);
      setSelectedSupplier("");
      if (selectedSupplier) {
        getDiscountCodes();
      } else {
  ...
  const updateSpecialPriceData = (type: string) => {
    ...
    if (formik.current.isValid) {
      ...
      setloading(true);
      console.log(formik.current.values.pricing_rules);
      const params: any = {
        organizations_id:
  ...
  //    method: 'GET',
  //    apiUrl: `${
  //      EndpointUrl.SpecialPrice
  //    }?organizations_id=${customerName}&page=${1}&perPage=${25}&vendor_id[0]=${selectedSupplier}`,
  //    headers: {},
  //  }
                  ...
                  <>
                    ...
                    >
                      <PricingRuleField style={{ gap: "16px" }}>
                        ...
                        <div className="each-div quote_number">
                          <PiInputForm
                            name="quote_number"
                      ...
                      <PricingFieldSection style={{ position: "relative" }}>
                        <PiTypography component="h4">
                          Pricing Rules
                        </PiTypography>
                        {values.pricing_rules.length > 0 &&
                          values.pricing_rules.map((friend, index) => (
                            <div
                              style={{
                                borderBottom: "1px solid var(--greyCardBorder)",
                              }}
                            >
                              <PricingRuleField className="pricing-rules-fields-div">
                                ...
                                >
                                  ...
                                  <PiSelectForm
                                    ...
                                    //isClearable={true}
                                    classNamePrefix="react-select"
                                    isDisabled={!initialValues.pricing_rules[index].supplier ? true : false}
                                    isMandatory
                                  />
                                </div>
                                <div className="w-20-div label-hidden">
                                  <PiInputForm
                                  ...
                                  />
                                      ...
                                      >
                                        <PiSelectForm
                                          ...
                                          // classNamePrefix="react-select"
                                          // className="multi-select react-select"
                                          isMulti
                                  ...
                                  >
                                    <div
                                      ...
                                      //     .item_range_specification ===
                                      //   "item_range"
                                      //     ? " w-80-div w-80-div fields-inside-60 w-100-div"
                                      //     : " w-80-div fields-inside-60 w-100-div w-100-div"
                                      // }
                                      className={
                                        initialValues.pricing_rules[index]
                                          .item_range_specification ===
                                  ...
                                  <PiIconInputForm
                                    ...
                                    isDisabled={
                                      initialValues.pricing_rules[index]
                                        .item_range_specification ===
                                        "item_range" || selectedItems.length > 1
                                        ? true
                                        : false
                                    }
                                  />
                                      ...
                                      >
                                        ...
                                        >
                                          <p
                                            ...
                                            style={{ margin: "0" }}
                                          >
                                            Markup(IIDM Price) % / Discount(List
                                            Price) %
                                          </p>
                                          <div
                                            style={{
                                        ...
                                        {initialValues.pricing_rules[index]
                                          ...
                                          selectedItems.length < 2 && (
                                            <PiIconInputForm
                                              name={`pricing_rules.${index}.fixed_value`}
                                              label="Fixed Sales Price"
                                              placeholder="Enter Fixed Sales Price"
                                              type="string"
                                              elemBeforeInput={
                                                <div
                                                  style={{
                              ...
                              {initialValues.pricing_rules[index]
                                .item_range_specification === "item_range" && (
                                <div style={{ paddingBottom: "10px" }}>
                                  <UploadNote className="for-item-range-notes">
                                    <span className="asterik">*</span>
                                    Discount % will be applied for the items in
