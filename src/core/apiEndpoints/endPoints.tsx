const EndpointUrl = {
  ...
  ItemInternalNotes: "v1/ItemInternalNotes",
  ContactsOrg: "v1/ContactsOrg",
  getRepairItemJobId: "v1/getRepairItemJobId",
  QuoteChangeLineOrder: "v1/Quote-ChangeLineOrder",
  ContactTypes: "v1/ContactTypes",
  UserBranches: "v1/User-Branches",
  acknowledge: "v1/acknowledge",
  SPImportAllCustomers: "v1/SPImportAllCustomers",
  SyncSoandJobs: "v1/syncSOandJobs",
  DeleteQuote: "v1/DeleteQuote",
  ArchiveQuote: "v1/ArchiveQuote",
  SyncJobs: "v1/syncJobs",
  SyncSo: "v1/syncSo",
};
